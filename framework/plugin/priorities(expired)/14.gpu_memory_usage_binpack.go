...
type GPUMemoryUsageBinpack struct{}

func (pl GPUMemoryUsageBinpack) Name() string {
	return "GPUMemoryUsageBinpack"
}

func (pl GPUMemoryUsageBinpack) Debugg(nodeInfoCache *r.NodeCache) {
	r.KETI_LOG_L2(fmt.Sprintf("[stage] S#14. %s", pl.Name()))
